  ...
  return (
    <div>
      <h2 id="sub-category-heading">
        <Translate contentKey="routineveeApp.subCategory.home.title">Sub Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="routineveeApp.subCategory.home.createLabel">Create new Sub Category</Translate>
        </Link>
      </h2>
        ...
        {subCategoryList && subCategoryList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="routineveeApp.subCategory.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="routineveeApp.subCategory.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="routineveeApp.subCategory.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="routineveeApp.subCategory.category">Category</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {subCategoryList.map((subCategory, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{subCategory.categoryId ? <Link to={`category/${subCategory.categoryId}`}>{subCategory.categoryId}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="routineveeApp.subCategory.home.notFound">No Sub Categories found</Translate>
            </div>
          )
        )}
      </div>
