...
export const SubCategoryDeleteDialog = (props: ISubCategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="routineveeApp.subCategory.delete.question">
        <Translate contentKey="routineveeApp.subCategory.delete.question" interpolate={{ id: subCategoryEntity.id }}>
