...
export const UserProfileDeleteDialog = (props: IUserProfileDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="routineveeApp.userProfile.delete.question">
        <Translate contentKey="routineveeApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
