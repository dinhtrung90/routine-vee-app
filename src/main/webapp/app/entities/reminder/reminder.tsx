  ...
  return (
    <div>
      <h2 id="reminder-heading">
        <Translate contentKey="routineveeApp.reminder.home.title">Reminders</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="routineveeApp.reminder.home.createLabel">Create new Reminder</Translate>
        </Link>
      </h2>
        ...
        {reminderList && reminderList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('reminderText')}>
                  <Translate contentKey="routineveeApp.reminder.reminderText">Reminder Text</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('date')}>
                  <Translate contentKey="routineveeApp.reminder.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {reminderList.map((reminder, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={reminder.date} format={APP_DATE_FORMAT} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="routineveeApp.reminder.home.notFound">No Reminders found</Translate>
            </div>
          )
        )}
      </div>
