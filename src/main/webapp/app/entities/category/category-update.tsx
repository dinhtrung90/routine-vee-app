  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="routineveeApp.category.home.createOrEditLabel">
            <Translate contentKey="routineveeApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : categoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="category-name">
                  <Translate contentKey="routineveeApp.category.name">Name</Translate>
                </Label>
                <AvField
                  id="category-name"
                  type="text"
              ...
              <AvGroup>
                <Label id="codeLabel" for="category-code">
                  <Translate contentKey="routineveeApp.category.code">Code</Translate>
                </Label>
                <AvField
                  id="category-code"
                  type="text"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="category-description">
                  <Translate contentKey="routineveeApp.category.description">Description</Translate>
                </Label>
                <AvField id="category-description" type="text" name="description" />
              </AvGroup>
              <AvGroup>
                <Label id="thumbUrlLabel" for="category-thumbUrl">
                  <Translate contentKey="routineveeApp.category.thumbUrl">Thumb Url</Translate>
                </Label>
                <AvField id="category-thumbUrl" type="text" name="thumbUrl" />
              </AvGroup>
