  ...
  return (
    <div>
      <h2 id="category-heading">
        <Translate contentKey="routineveeApp.category.home.title">Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="routineveeApp.category.home.createLabel">Create new Category</Translate>
        </Link>
      </h2>
        ...
        {categoryList && categoryList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="routineveeApp.category.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="routineveeApp.category.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="routineveeApp.category.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('thumbUrl')}>
                  <Translate contentKey="routineveeApp.category.thumbUrl">Thumb Url</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="routineveeApp.category.home.notFound">No Categories found</Translate>
            </div>
          )
        )}
      </div>
